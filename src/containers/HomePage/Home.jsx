  ...
  const datatest = [
    {
      title: "NỮ",
      imgUrl:
        "https://media.canifa.com/Simiconnector/list_image_tablet1694484733.webp",
    },
    {
      title: "NAM",
      imgUrl:
        "https://media.canifa.com/Simiconnector/list_image_tablet_second1694484734.webp",
    },
    {
      title: "BÉ GÁI",
      imgUrl:
        "https://media.canifa.com/Simiconnector/list_image_tablet_third1694484734.webp",
    },
    {
      title: "BÉ TRAI",
      imgUrl:
        "https://media.canifa.com/Simiconnector/list_image_tablet_41694484734.webp",
    },
  ];
    ...
    <div className="home-page">
      ...
      <div className="site-main">
        ...
        <div className="block-newProduct">
          <Container sx={{ marginTop: "25px" }}>
            <div className="bock-product-heading" id="blockProductHeading">
              <h2>Gợi ý cho bạn</h2>
            </div>
            <Box
              sx={{
