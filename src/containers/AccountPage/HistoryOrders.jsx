...
import { GetOrders, PostCancelOrder } from '../../services/orderService';
...
const HistoryOrders = () => {
    ...
    React.useEffect(() => {
        setDataAPage(dataOrder.slice(page * 4 - 4, page * 4));
    }, [page, dataOrder]);
    ...
    return (
        <>
            <Scroll.Element name="secondInsideContainer"></Scroll.Element>
                        ...
                        )}
                        {
                            ...
                            >
                                ...
                                >
                                    <Pagination
                                        count={
                                            dataOrder.length % 4 === 0
                                                ? dataOrder.length / 4
                                                : Math.floor(dataOrder.length / 4) +
                                                1
                                        }
                                        page={page}
