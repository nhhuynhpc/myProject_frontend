...
import { GetCustomerObject } from '../../../services/productService';
import { GetListCategories } from '../../../services/categoriesService';
...
const AddProduct = (props) => {
    ...
    React.useEffect(() => {
        setDataProduct({
            ...
            customers_object_id:
                props.dataThisProduct?.customers_object_id ?? '',
        ...
        setShowImage(
            props.dataThisProduct?.image
                ? API + props.dataThisProduct?.image
                : null
        );
    ...
    return (
        <>
            <Container>
                ...
                >
                    <DialogTitle>
                        {props.typeEdit === 0 ? 'Thêm sản phẩm' : 'Chỉnh sửa'}
                    </DialogTitle>
                    <DialogContent>
                        <Container
                            sx={{
                    ...
                    <DialogActions>
                        <Button
                            onClick={() =>
                                props.postData(dataProduct, selectedImage)
                            }
                            sx={{
                                width: '250px',
