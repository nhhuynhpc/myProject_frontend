...
const SearchResult = () => {
    ...
    React.useEffect(() => {
        setResultProduct(
            resultSearch.productSearched.resultSearchProduct ?? []
        );
            ...
            <div className="search-view">
                ...
                >
                    ...
                    >
                        ...
                        <Typography sx={{ fontSize: '14px', color: '#B7B7B7' }}>
                            Vui lòng thay đổi tiêu chí tìm kiếm của bạn và thử
                            lại. Nếu vẫn không tìm thấy bất kỳ điều gì có liên
                            quan, vui lòng truy cập Trang chủ và thử một phần
